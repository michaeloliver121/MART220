 ...
 // "Player" Icon smack center of canvas
 let playerx = 250;
 let playery = 250;
 ...
 function setup()
    {
        ...
        // Should randomize cloud locations when running
        cloud1x = random(50,450);
        cloud1y = random(40,450);
        cloud2x = random(50,450);
        cloud2y = random(40,450);
        cloud3x = random(50,450);
        cloud3y = random(40,450);
    }

function draw() {

    // Drawing the map "parchment", border, and legend
  ...
  circle(cloud2x, cloud2y, 40);
  circle(cloud2x + 20, cloud2y + 5, 40);
  circle(cloud3x, cloud3y, 60);
